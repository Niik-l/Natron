...
#ifndef NATRON_ENGINE_DEEPCROP_H
#define NATRON_ENGINE_DEEPCROP_H
...
/**
 * @brief Crop a deep image in XY. Pixels outside the crop region are discarded.
 */
class DeepCrop
...
public:
    ...
    static EffectInstance* BuildEffect(NodePtr n) { return new DeepCrop(n); }

    DeepCrop(NodePtr node);
    virtual ~DeepCrop();
    ...
    { return PLUGINID_NATRON_DEEPCROP; }
...
private:
    ...
    std::unique_ptr<DeepCropPrivate> _imp;
    mutable DeepImagePtr _lastDeepImage;
};

NATRON_NAMESPACE_EXIT

#endif // NATRON_ENGINE_DEEPCROP_H
