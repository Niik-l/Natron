...
#ifndef NATRON_ENGINE_DEEPCONSOLIDATE_H
#define NATRON_ENGINE_DEEPCONSOLIDATE_H
...
/**
 * @brief Tidy and optimize deep images by merging overlapping samples,
 * removing zero-alpha samples, and optionally reducing sample count.
 *
 * This improves downstream performance and fixes common deep image artifacts.
 */
class DeepConsolidate
...
public:
    ...
    {
        return new DeepConsolidate(n);
    }

    DeepConsolidate(NodePtr node);

    virtual ~DeepConsolidate();
    ...
    {
        return PLUGINID_NATRON_DEEPCONSOLIDATE;
    }

    virtual std::string getPluginLabel() const OVERRIDE FINAL WARN_UNUSED_RETURN
    {
        return "DeepConsolidate";
    }
...
private:
    ...
    std::unique_ptr<DeepConsolidatePrivate> _imp;
    mutable DeepImagePtr _lastDeepImage;
};

NATRON_NAMESPACE_EXIT

#endif // NATRON_ENGINE_DEEPCONSOLIDATE_H
