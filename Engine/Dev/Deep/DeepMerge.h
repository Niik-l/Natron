...
#ifndef NATRON_ENGINE_DEEPMERGE_H
#define NATRON_ENGINE_DEEPMERGE_H
...
public:
    ...
    {
        return new DeepMerge(n);
    }

    DeepMerge(NodePtr node);
    ...
    {
        return PLUGINID_NATRON_DEEPMERGE;
    }
    ...
    /**
     * @brief Get the merged deep image for downstream deep-aware nodes.
     */
...
private:
    ...
    std::unique_ptr<DeepMergePrivate> _imp;
};

NATRON_NAMESPACE_EXIT

#endif // NATRON_ENGINE_DEEPMERGE_H
