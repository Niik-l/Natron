...
#ifndef NATRON_ENGINE_DEEPFLATTEN_H
#define NATRON_ENGINE_DEEPFLATTEN_H
...
public:
    ...
    {
        return new DeepFlatten(n);
    }

    DeepFlatten(NodePtr node);
    ...
    {
        return PLUGINID_NATRON_DEEPFLATTEN;
    }
...
#endif // NATRON_ENGINE_DEEPFLATTEN_H
