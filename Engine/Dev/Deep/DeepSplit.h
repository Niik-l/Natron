...
#ifndef NATRON_ENGINE_DEEPSPLIT_H
#define NATRON_ENGINE_DEEPSPLIT_H
...
/**
 * @brief Split a deep image into front/back portions by depth threshold.
 *
 * Samples in front of the threshold go to the 'Front' output,
 * samples behind go to 'Back'. This is the inverse of DeepMerge.
 *
 * Optionally applies a soft blend at the threshold boundary.
 */
class DeepSplit
...
public:
    ...
    {
        return new DeepSplit(n);
    }

    DeepSplit(NodePtr node);
    ...
    {
        return PLUGINID_NATRON_DEEPSPLIT;
    }
...
private:
    ...
    std::unique_ptr<DeepSplitPrivate> _imp;
    mutable DeepImagePtr _lastDeepImage;
};

NATRON_NAMESPACE_EXIT

#endif // NATRON_ENGINE_DEEPSPLIT_H
