...
#ifndef NATRON_ENGINE_DEEPWRITE_H
#define NATRON_ENGINE_DEEPWRITE_H
...
/**
 * @brief Write deep image data to a deep EXR file.
 */
class DeepWrite
...
public:
    ...
    static EffectInstance* BuildEffect(NodePtr n) { return new DeepWrite(n); }

    DeepWrite(NodePtr node);
    virtual ~DeepWrite();
    ...
    { return PLUGINID_NATRON_DEEPWRITE; }
...
private:
    ...
    std::unique_ptr<DeepWritePrivate> _imp;
};

NATRON_NAMESPACE_EXIT

#endif // NATRON_ENGINE_DEEPWRITE_H
