...
#ifndef NATRON_ENGINE_DEEPCHANNELMATH_H
#define NATRON_ENGINE_DEEPCHANNELMATH_H
...
/**
 * @brief Perform per-sample math operations on deep image channels.
 *
 * Multiply, add, or set channels to constant values on every sample.
 *
 * The output is a modified deep image.
 */
class DeepChannelMath
...
public:
    ...
    {
        return new DeepChannelMath(n);
    }

    DeepChannelMath(NodePtr node);

    virtual ~DeepChannelMath();
    ...
    {
        return PLUGINID_NATRON_DEEPCHANNELMATH;
    }

    virtual std::string getPluginLabel() const OVERRIDE FINAL WARN_UNUSED_RETURN
    {
        return "DeepChannelMath";
    }
...
private:
    ...
    std::unique_ptr<DeepChannelMathPrivate> _imp;
    mutable DeepImagePtr _lastDeepImage;
};

NATRON_NAMESPACE_EXIT

#endif // NATRON_ENGINE_DEEPCHANNELMATH_H
