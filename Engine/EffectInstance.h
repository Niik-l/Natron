...
#define PLUGINID_NATRON_CAMERATRACKER (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.CameraTracker")
#define PLUGINID_NATRON_POINTCLOUDGEN (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.PointCloudGenerator")
...
// Deep Compositing nodes
#define PLUGINID_NATRON_DEEPREAD         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepRead")
#define PLUGINID_NATRON_DEEPWRITE        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepWrite")
#define PLUGINID_NATRON_DEEPFLATTEN      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepFlatten")
#define PLUGINID_NATRON_DEEPMERGE        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepMerge")
#define PLUGINID_NATRON_DEEPRECOLOR      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepRecolor")
#define PLUGINID_NATRON_DEEPSLICE        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepSlice")
#define PLUGINID_NATRON_DEEPHOLDOUT      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepHoldout")
#define PLUGINID_NATRON_DEEPFROMIMAGE    (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepFromImage")
#define PLUGINID_NATRON_DEEPGRADE        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepGrade")
#define PLUGINID_NATRON_DEEPREFORMAT     (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepReformat")
#define PLUGINID_NATRON_DEEPCROP         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepCrop")
#define PLUGINID_NATRON_DEEPTOPOINTS     (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepToPoints")
#define PLUGINID_NATRON_DEEPTRANSFORM    (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepTransform")
#define PLUGINID_NATRON_DEEPEXPRESSION   (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepExpression")
#define PLUGINID_NATRON_DEEPCOLORCORRECT (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepColorCorrect")
#define PLUGINID_NATRON_DEEPDEFOCUS      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepDefocus")
#define PLUGINID_NATRON_DEEPAO           (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepAO")
#define PLUGINID_NATRON_DEEPBLEND        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepBlend")
#define PLUGINID_NATRON_DEEPCHANNELMATH  (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepChannelMath")
#define PLUGINID_NATRON_DEEPCONSOLIDATE  (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepConsolidate")
#define PLUGINID_NATRON_DEEPCONTACTSHADOW (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepContactShadow")
#define PLUGINID_NATRON_DEEPDEPTHWARP    (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepDepthWarp")
#define PLUGINID_NATRON_DEEPDIFFERENCE   (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepDifference")
#define PLUGINID_NATRON_DEEPFOG          (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepFog")
#define PLUGINID_NATRON_DEEPFROMFRAMES   (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepFromFrames")
#define PLUGINID_NATRON_DEEPGODRAYS      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepGodRays")
#define PLUGINID_NATRON_DEEPLAYERBREAK   (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepLayerBreak")
#define PLUGINID_NATRON_DEEPNORMALMATTE  (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepNormalMatte")
#define PLUGINID_NATRON_DEEPNORMALIZE    (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepNormalize")
#define PLUGINID_NATRON_DEEPPOSITIONMATTE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepPositionMatte")
#define PLUGINID_NATRON_DEEPQUANTIZE     (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepQuantize")
#define PLUGINID_NATRON_DEEPRELIGHT      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepRelight")
#define PLUGINID_NATRON_DEEPSAMPLEFILTER  (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepSampleFilter")
#define PLUGINID_NATRON_DEEPSPLIT        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepSplit")
#define PLUGINID_NATRON_DEEPVELOCITYMATTE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DeepVelocityMatte")

// 3D System nodes
#define PLUGINID_NATRON_CAMERA3DNODE     (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Camera3D")
#define PLUGINID_NATRON_SPHERE3D         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Sphere3D")
#define PLUGINID_NATRON_CARD3D           (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Card3D")
#define PLUGINID_NATRON_CUBE3D           (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Cube3D")
#define PLUGINID_NATRON_CYLINDER3D       (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Cylinder3D")
#define PLUGINID_NATRON_SCENE3D          (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Scene3D")
#define PLUGINID_NATRON_SCANLINERENDER   (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ScanlineRender")
#define PLUGINID_NATRON_CYCLESRENDER    (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.CyclesRender")
#define PLUGINID_NATRON_FASTVOLUMERENDER (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.FastVolumeRender")
#define PLUGINID_NATRON_CYCLESRENDERPASSMANAGER (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.CyclesRenderPassManager")
#define PLUGINID_NATRON_CYCLESRENDERSETTINGS     (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.CyclesRenderSettings")
#define PLUGINID_NATRON_MATERIAL3D      (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Material3D")
#define PLUGINID_NATRON_LIGHT3D          (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Light3D")
#define PLUGINID_NATRON_PROJECT3D        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Project3D")
#define PLUGINID_NATRON_MERGEMAT         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.MergeMat")
#define PLUGINID_NATRON_UVPROJECT        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.UVProject")
#define PLUGINID_NATRON_GROUP3D          (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Group3D")
#define PLUGINID_NATRON_VOLUME3D         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Volume3D")
#define PLUGINID_NATRON_READVDB          (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ReadVDB")
#define PLUGINID_NATRON_READALEMBICCAMERA (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ReadAlembicCamera")
#define PLUGINID_NATRON_READALEMBICTRANSFORM (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ReadAlembicTransform")
#define PLUGINID_NATRON_READALEMBICARCHIVE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ReadAlembicArchive")
#define PLUGINID_NATRON_READGEO          (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ReadGeo")
#define PLUGINID_NATRON_GEOBUILDER       (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.GeoBuilder")
#define PLUGINID_NATRON_PATH3D           (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Path3D")
#define PLUGINID_NATRON_GEOMATERIALOVERRIDE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.GeoMaterialOverride")
#define PLUGINID_NATRON_DEVSTAMP         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DevStamp")
#define PLUGINID_NATRON_CYCLESRENDERPASS (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.CyclesRenderPass")
// Old plugin ID before the RenderPass -> CyclesRenderPass rename; kept so saved
// projects that reference it still resolve the node via getPluginBinaryFromOldID.
#define PLUGINID_NATRON_RENDERPASS_OLD   (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.RenderPass")

// PostFX (2D consumers of 3D AOVs)
#define PLUGINID_NATRON_VECTORBLUR       (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.VectorBlur")
#define PLUGINID_NATRON_ZDEFOCUS         (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ZDefocus")
#define PLUGINID_NATRON_PMASK            (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.PMask")

// Channel routing
#define PLUGINID_NATRON_DEVSHUFFLE       (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.DevShuffle")

// Transform
#define PLUGINID_NATRON_SPHERICALTRANSFORM (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.SphericalTransform")
#define PLUGINID_NATRON_LENSWARP (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.LensWarp")

// Color
#define PLUGINID_NATRON_COLORCHARTMATCH (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ColorChartMatch")
#define PLUGINID_NATRON_COLORMATRIX     (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ColorMatrix")
#define PLUGINID_NATRON_EXPOSURE        (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Exposure")
#define PLUGINID_NATRON_BLAST           (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.Blast")

// Particle System nodes
#define PLUGINID_NATRON_PARTICLEEMITTER  (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleEmitter")
#define PLUGINID_NATRON_PARTICLEGRAVITY  (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleGravity")
#define PLUGINID_NATRON_PARTICLEDRAG    (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleDrag")
#define PLUGINID_NATRON_PARTICLETURBULENCE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleTurbulence")
#define PLUGINID_NATRON_PARTICLETURBULENCE2D (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleTurbulence2D")
#define PLUGINID_NATRON_PARTICLEWIND (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleWind")
#define PLUGINID_NATRON_PARTICLEKILLBOX (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleKillBox")
#define PLUGINID_NATRON_PARTICLEATTRACT (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleAttract")
#define PLUGINID_NATRON_PARTICLEVORTEX (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleVortex")
#define PLUGINID_NATRON_PARTICLESPAWN (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleSpawn")
#define PLUGINID_NATRON_PARTICLESOLVER (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleSolver")
#define PLUGINID_NATRON_PARTICLEMERGE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleMerge")
#define PLUGINID_NATRON_POINTSTOPARTICLES (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.PointsToParticles")
#define PLUGINID_NATRON_PARTICLEMATERIAL (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleMaterial")
#define PLUGINID_NATRON_PARTICLEINSTANCE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleInstance")
#define PLUGINID_NATRON_WRITEALEMBICPARTICLES (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.WriteAlembicParticles")
#define PLUGINID_NATRON_READALEMBICPARTICLES (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ReadAlembicParticles")
#define PLUGINID_NATRON_PARTICLEATTRIBUTE (NATRON_ORGANIZATION_DOMAIN_TOPLEVEL "." NATRON_ORGANIZATION_DOMAIN_SUB ".built-in.ParticleAttribute")
